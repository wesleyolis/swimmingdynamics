...
/*
		...
		//  echo "fina:".$fina_year;
		  ...
		  $query="Update ".$tm4db.".result_".$season." as u, (SELECT r.result,  Round(1000*Pow((f.Score/r.score),3)) as Fina2 FROM ".$tm4db.".result_".$season." as r inner join ".$tm4db.".athlete_".$season." as a on (r.ATHLETE=a.Athlete) inner join drupal_5_perfanal.fina_points as f on (r.Course=f.Course and (r.I_R=f.I_R Or (r.I_R='L' And f.I_R='I')) and r.Stroke=f.Stroke and r.Distance=f.Distance and a.sex=f.Sex)";
