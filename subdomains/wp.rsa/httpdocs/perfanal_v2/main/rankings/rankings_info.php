	...
	if($running_config['ranking_type']=='archive')
	...
	else
	  {
	     If($update=='M')
	       ...
	       $output.="Rankings are updated every ".$period." Weeks.<br/><br/>";
	  }

	$output.="Swimmers ages are determined as at the current rankings date. (".$_GET['d'].")<br/>";
	$output.="Note: The age group filters looks at the Swimmers age as of the current rankings date.<br/><br/>";
	$output.="Meet Results that are considered for rankings must have ended ".$rank_days_before." days prior to the rankings date. (".$_GET['d'].")<br/>";
	$output.="To view list of meets included in this rankings set click the 'Meets' link on rankings page.<br/>";
