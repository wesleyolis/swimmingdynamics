...
switch($arg[0])
     {
      case 'about':
	  {
	     ...
	     $output.="</ul></div><br><br>";
	     $output.="The FINA Point Scoring system allows for comparisons of results across different events. The FINA Point<br>";
	     $output.="Scoring system assigns values to swimming performances based on tables, more points for world class performances<br>";
	     $output.="typically 1000 or more and fewer points for slower performances.<br>";
	     $output.="Point values are assigned every four years after the Olympic Games. The tables have one set of<br>";
	     $output.="points for Short Course and another for Long Course.<br>";
	     $output.="The scoring is named by the year of the Olympic Games, after which the base times were, determined<br>";
	     $output.="e.g. 'FINA Point Scoring 2004' after the Games of Athens 2004.<br><br>";
