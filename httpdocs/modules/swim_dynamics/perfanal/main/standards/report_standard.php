	...
	if(arg(2)==null)
	...
	else
	  {
	     ...
	     if(db_num_rows($result)>0)
		  ...
		  while($object = db_fetch_object($results))
		    $rows[] = array(($object->_desc==null)?(array('data'=>'Total','class'=>'green')):$object->_desc,($object->Sex==null)?(array('data'=>'Total','class'=>'green')):Gender($object->Sex),($object->mqt==null)?(($object->Sex==null)?array('data'=>'','class'=>'green'):(array('data'=>'Total','class'=>'green'))):$des[$object->mqt],($object->mqt==null)?array('class'=>'green','data'=>$object->ath):$object->ath);
	       }
