<?php
		  ...
		  switch(arg(4))
		    {
			 ...
			 {
			    if (arg(5) !=null)
			      $name_filter = "and LCASE(CONCAT(CONCAT(a.Last,a.First),a.Last)) like '".str_replace(" ", "%%",(' '.strtolower(arg(5)).' '))."' ";
			    else
			      $name_filter = "";
			 }
		       break;
		     ...
		     case 'ln':
			 {
			    $name_filter = " and a.Last like CONCAT('%%','".strtolower(arg(5))."%%') ";
			 }
		       break;
			 ...
			 {
			    if (arg(5))
			      $name_filter = " and a.First like CONCAT('%%','".strtolower(arg(5))."%%') ";
			    else
			 ...
			 {
			    if(arg(3)!=null)
			      $name_filter = "and a.Last like '%%".arg(4)."%%' ";
			    else
			      $name_filter = "and a.Athlete=0 ";
			 }
		       break;
		  ...
		  switch(arg(3))
		    {
			 ...
			 {
			    if(arg(3)!=null)
			      $clubs_filter = " and a.Team1=".arg(3)." ";
			    else
			      $clubs_filter = "";
			 }
		       break;
	     ...
	     $result = db_query("select SQL_CACHE a.Athlete,a.Last,a.First,a.Sex,t.TCode,extract(YEAR FROM from_days(datediff(CURDATE(), a.Birth))) as Age  from ".$tm4db."athlete_".$season." as a inner join ".$tm4db."team_".$season." as t on (a.Team1=t.Team) where 1=1 ".$name_filter." ".$clubs_filter." order by a.Last,a.first");
