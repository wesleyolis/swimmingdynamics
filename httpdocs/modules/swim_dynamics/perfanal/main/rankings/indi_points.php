<?php
 ...
 $headers[] = array('data' => t('#'), 'width' => '20px');
   ...
   $result = db_query_pages($query,'','ranking/'.arg(1).'/'.arg(3).'/'.arg(4).'/'.arg(5).'/'.arg(6).'/'.arg(7).'/'.arg(8));
   ...
   if (!$rows)
     {
	$rows[] = array(array('data' => t('There are no athletes results found matching your criteria, click '.l(t('here'), 'ranking/'.arg(1).'/'.arg(2).'/'.arg(3).'/'.arg(4).'/'.arg(5)).' to go back.'), 'colspan' => 6));
     }
