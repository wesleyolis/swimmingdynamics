// $Id: ajaxsubmit.js,v 1.8 2007/02/04 19:08:27 nedjo Exp $

/**
 * Attaches the ajaxsubmit behaviour to forms.
 */
Drupal.ajaxsubmitAutoAttach = function () {
...
if (Drupal.jsEnabled) {
  $(document).ready(Drupal.ajaxsubmitAutoAttach);
}