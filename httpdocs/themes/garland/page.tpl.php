...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language ?>" lang="<?php print $language ?>">
  <head>
  <meta name="verify-v1" content="gq/HSPAjKD61J8vItjroLSWNLRgftHMgLo2yWhX1fv8=" >
    <title><?php print $head_title ?></title>
    <?php print $head ?>
    <?php
    /*
    $style = variable_get('drupal_css_preprocess_filenames', false);
      <link rel="stylesheet" href="<?php print substr($style,0,strlen($style)-1) ?>" type="text/css">
      */
    ?>
...
<?php include "advert_banner.html" ?>
